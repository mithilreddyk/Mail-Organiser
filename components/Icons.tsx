...
export const LogoIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M2.5 4.5h19c.83 0 1.5.67 1.5 1.5v12c0 .83-.67 1.5-1.5 1.5h-19C1.67 19.5 1 18.83 1 18V6c0-.83.67-1.5 1.5-1.5M2.5 5.5v.42l9.46 5.67c.02.01.05.02.07.03.02,0 .05-.01.07-.03L21.5 5.92V5.5h-19M2.5 18.5h19V7.59l-9.43 5.66c-.32.19-.71.19-1.03.01L2.5 7.59v10.91z" />
    </svg>
);
